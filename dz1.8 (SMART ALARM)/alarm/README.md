...
|---|---|
| <img src="schema.png" width="400" alt="Схема підключення у Wokwi"> | <img src="photo_1.jpeg" width="400" alt="Вид зверху: три світлодіоди з резисторами, фоторезистор, бузер і дві кнопки"> |

Той самий стенд збоку:

<img src="photo_2.jpeg" width="400" alt="Вид збоку на макетну плату з ESP32-S3">
