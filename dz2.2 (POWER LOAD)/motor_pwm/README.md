...
|---|---|---|
| ручка на 30 % | <img src="analysis/pwm-30-high.png" width="330" alt="Вимір високого рівня при заповненні 30 %: 299.875 мкс"> | <img src="analysis/pwm-30-low.png" width="330" alt="Вимір низького рівня при заповненні 30 %: 701.015 мкс"> |
| | 299.875 мкс (прошивка: 300) | 701.015 мкс (прошивка: 700) |
| ручка на 80 % | <img src="analysis/pwm-80-high.png" width="330" alt="Вимір високого рівня при заповненні 80 %: 799.375 мкс"> | <img src="analysis/pwm-80-low.png" width="330" alt="Вимір низького рівня при заповненні 80 %: 199.75 мкс"> |
| | 799.375 мкс (прошивка: 800) | 199.75 мкс (прошивка: 200) |
