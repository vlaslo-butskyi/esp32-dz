...
<a href="analysis/uart-00.png"><img src="analysis/uart-00.png" alt="Захоплення 0x00: вузькі поодинокі імпульси на низькому тлі, один на кадр"></a>

**`0xFF` — 90 %.** Дзеркальна картинка: лінія майже весь час висока, вниз провалюється тільки стартовий біт.

<a href="analysis/uart-ff.png"><img src="analysis/uart-ff.png" alt="Захоплення 0xFF: майже суцільний високий рівень з вузькими провалами стартових бітів"></a>
...
<a href="analysis/uart-0f.png"><img src="analysis/uart-0f.png" alt="Захоплення 0x0F: широкий імпульс, широка пауза і окремий вузький пік стопового біта"></a>
...
<a href="analysis/uart-55.png"><img src="analysis/uart-55.png" alt="Захоплення 0x55: рівна часта гребінка, усі імпульси однакової ширини"></a>
